...
#### Analysis: How many people used the sleep tracking feature?
...
#### Analysis: What quantity of sleep are users getting?
...
#### Analysis: What quality of sleep are users getting?
...
#### Analysis: Did sleep quantity or quality improve over time?

```{r viz_sleep_over_time_bruteforce, eval=FALSE}
# get_time_coefficients_plot <- function(ids, timestamps, values)
ggplot(sleep_time_data,
       aes(x = sleep_date,
           y = pct_asleep)) +
  geom_point() +
  geom_smooth(method = "lm",
    ...
    stat_cor(mapping=aes(label=..rr.label..),
             ...
             vjust = 1.1) +
  facet_wrap(vars(id))
# Brute-force findings: Most lines are flat, with some (5-6) that are slightly down
```
...
get_time_coefficients_plot(sleep_time_data$id,
                         sleep_time_data$sleep_date,
                         sleep_time_data$minutes_asleep) +
...
#### Analysis: How often do people track their heart-rate?
...
#### Analysis: What levels of activity do people typically track?
