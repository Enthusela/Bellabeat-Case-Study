...
Based on my analysis in the previous step, I present the following findings from the data set:
...
I found a strong correlation between time spent exercising and distance covered, which indicates users prefer mobile exercise; if the opposite was true and users spent their active time stationary, we would have seen more users with higher active minutes but low distance.
...
<div style="text-align: center;">
  ![Bellabeat Ivy on a woman's wrist](imgs/bellabeat_ivy_on_wrist_cropped.png)
</div>
